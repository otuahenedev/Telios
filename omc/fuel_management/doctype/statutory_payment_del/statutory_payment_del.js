...
// frappe.ui.form.on("Statutory Payment del", {
// 	refresh(frm) {
...
function create_payment_entry(frm) {
    frappe.new_doc("Payment Entry", {
        ...
        paid_amount: frm.doc.total_tax_amount, // Total tax amount from Statutory Payment del
        reference_no: frm.doc.name, // Reference Statutory Payment del name
        reference_date: frappe.datetime.now_date(), // Default to today
        custom_reference_doc: "Statutory Payment del", // Reference document type
